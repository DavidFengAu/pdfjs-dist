...
var PDFViewerApplication = {
  ...
  bindWindowEvents: function bindWindowEvents() {
    ...
    appConfig.appContainer.addEventListener('resize', _boundEvents.windowResize);
  ...
  unbindWindowEvents: function unbindWindowEvents() {
    ...
    appConfig.appContainer.removeEventListener('resize', _boundEvents.windowResize);
...
function webViewerClick(evt) {
  ...
  if (PDFViewerApplication.pdfViewer.containsElement(evt.target) || (appConfig.toolbar.container.contains(evt.target) && !appConfig.secondaryToolbar.toggleButton.contains(evt.target))) {
